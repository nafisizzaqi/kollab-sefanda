        ...
        <tbody>
            @forelse ($abouts ?? [] as $about)
                <tr>
                    ...
                    <td>
                        @if ($about->logo)
                            <img src="{{ asset('storage/' . $about->logo) }}" alt="Gambar" width="100">
                        @else
                            -
                        @endif
                    </td>
                    ...
                    <td>
                        ...
                        <form action="{{ route('pages.about.destroy', $about->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                            @csrf
                            @method('DELETE')
